    ...
    <div className="max-w-[880px] mx-auto p-4 space-y-6">
      <section className="bg-white rounded-2xl p-6 md:p-8 shadow-[0_4px_12px_rgba(0,0,0,0.05)] flex flex-col md:flex-row gap-6 relative">
        <div className="w-[120px] h-[120px] rounded-full overflow-hidden border-4 border-[#efeded] shrink-0 mx-auto md:mx-0">
          <Image src="https://picsum.photos/seed/alex/150/150" alt="Avatar" width={120} height={120} className="object-cover w-full h-full" unoptimized referrerPolicy="no-referrer" />
        </div>
        <div className="flex-1">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start text-center md:text-left gap-4">
            <div>
              <h1 className="text-2xl font-bold text-[#1b1c1c]">Alex Rivera</h1>
              <p className="text-[#5c5c5c] text-sm md:mt-1">@arivera_edu</p>
              <div className="flex gap-4 mt-3 justify-center md:justify-start">
                <div className="flex items-center gap-1">
                  <span className="font-bold text-[#1b1c1c]">163</span>
                  <span className="text-sm text-[#5c5c5c]">Followers</span>
                </div>
                <div className="flex items-center gap-1">
                  <span className="font-bold text-[#1b1c1c]">160</span>
          ...
          <p className="text-sm text-[#5c5c5c] leading-relaxed mt-5">
            Passionate about interactive learning and AI-driven education. Currently exploring the intersection of cognitive psychology and digital game-based learning.
          </p>
          <div className="mt-5 flex flex-wrap gap-2 justify-center md:justify-start">
            <span className="px-3 py-1 bg-[#fef3ea] text-[#f36710] rounded-full text-xs font-semibold tracking-wide">#Tech</span>
            <span className="px-3 py-1 bg-[#E0F6FE] text-[#00afef] rounded-full text-xs font-semibold tracking-wide">#Travel</span>
            <span className="px-3 py-1 bg-[#f5f5f5] text-[#594137] rounded-full text-xs font-semibold tracking-wide">#EdTech</span>
            <span className="px-3 py-1 bg-[#f5f5f5] text-[#594137] rounded-full text-xs font-semibold tracking-wide">#Design</span>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white rounded-3xl w-full max-w-md p-8 relative animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="space-y-5">
              <div className="flex flex-col gap-1.5">
                ...
                <input className="w-full border border-[#d9d9d9] rounded-xl px-4 py-3.5 focus:border-[#f36710] focus:ring-1 focus:ring-[#f36710] outline-none transition-all" defaultValue="Alex Rivera" />
              </div>
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input className="w-full border border-[#d9d9d9] rounded-xl pl-8 pr-4 py-3.5 focus:border-[#f36710] focus:ring-1 focus:ring-[#f36710] outline-none transition-all" defaultValue="arivera_edu" />
                </div>
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-bold text-[#5c5c5c] tracking-wider uppercase">Bio</label>
                <textarea className="w-full border border-[#d9d9d9] rounded-xl px-4 py-3.5 focus:border-[#f36710] focus:ring-1 focus:ring-[#f36710] outline-none resize-none h-28 transition-all" defaultValue="Passionate about interactive learning and AI-driven education. Currently exploring the intersection of cognitive psychology and digital game-based learning." />
              </div>
