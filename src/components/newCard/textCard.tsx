...
function TextFeed({ author, time, title, content, upvotes, downvotes, comments, authorInitial, authorBg }: any) {
  return (
...
function TextReel({ title, content, tags, author, time, upvotes, comments, onCommentToggle }: any) {
  return (
...
function TextExplore({ tag, title, content, author, upvotes, color = "border-l-secondary" }: any) {
  return (
...
function TextProfile({ tag, title, content }: any) {
  return (
