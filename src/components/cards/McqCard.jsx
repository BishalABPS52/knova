...
function MCQFeed({ author, time, question, options, correctIndex, explanation, upvotes, downvotes, authorInitial, authorBg, authorImg }) {
...
function MCQReel({ question, options, correctIndex, explanation, tags, author, time, upvotes, comments, onCommentToggle }) {
  const [selected, setSelected] = useState(null);
...
function MCQExplore({ tag, question, options, author, upvotes, correctIndex = -1 }) {
  return (
...
function MCQProfile({ tag, question, options, highlightIndex = -1 }) {
  return (
